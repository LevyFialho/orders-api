...
disk_format() {
	...
	for ((j=1;j<=3;j++))
	do
		wget https://raw.githubusercontent.com/stone-payments/financial-charging-infra/master/src/FinancialChargingApi.Azure/mongodb/centos/replicaset/scripts/vm-disk-utils.sh 
