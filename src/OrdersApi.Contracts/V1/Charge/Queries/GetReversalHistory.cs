...
namespace OrdersApi.Contracts.V1.Charge.Queries
{
    ...
    public class GetReversalHistory : ClientBoundRequest
    {
        [JsonIgnore]
        ...
        [JsonIgnore]
        protected string ReversalKey { get; set; }
        ...
        public virtual void SetInternalReversalKey(string key)
        {
            ReversalKey = key;
        }
        ...
        public virtual ISpecification<ChargeProjection> Specification()
        {
            ...
            if (!string.IsNullOrWhiteSpace(ReversalKey))
                spec = spec && ChargeSpecifications.ProjectionByReversalKey(ReversalKey);
